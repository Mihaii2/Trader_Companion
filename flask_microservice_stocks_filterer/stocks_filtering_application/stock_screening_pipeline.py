...
obligatory_data_filter = os.path.join(script_dir, "ranking_screens", "passed_stocks_input_data", "obligatory_screen_data_filter.py")
...
def run_script(script_path, args=None):
    ...
    stderr_thread = threading.Thread(
        target=print_output, 
        args=(process.stderr, f"[{script_name} ERROR]"),
        daemon=True
    )
...
def main():
    ...
    if args.fetch_data:
        ...
        run_script(price_fundamental_script)
    else:
