...
output_file1 = os.path.join(script_dir, "stocks_filtering_application", "minervini_4mo", "ranking_screens", "passed_stocks_input_data", "filtered_annual_fundamental_data_2years.csv")
