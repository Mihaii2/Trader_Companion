...
output_file = os.path.join(script_dir, "stocks_filtering_application", "minervini_4mo", "ranking_screens", "results", "max_rsi_3m.csv")
...
print(f"Top stocks by maximum RSI (last 3 months) have been saved to {output_file}")
