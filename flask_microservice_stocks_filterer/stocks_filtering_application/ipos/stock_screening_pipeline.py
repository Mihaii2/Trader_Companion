...
def main():
    ...
    ranking_screens = [
        ...
        for name in ["good_rsi_against_market", "top_price_increases_1y", "price_spikes", "volume_acceleration", "top_price_tightness_1w", "top_rsi", "mvp", "days_traded", "top_rsi_6m", "top_rsi_12m"]
    ]
